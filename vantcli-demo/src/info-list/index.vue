<template>
  <div class="infoCaption" :class="[wrapAlign, wrapWidth]">
    <div
      class="captionBox"
      :class="[
        boxAlign,
    ...
    >
      ...
      >
        <div class="captionBoxTitle">{{ item.name }}</div>
        <img class="upImg" v-if="item.upIcon" :src="item.upIcon" />
        <span v-if="item.up" class="captionBoxUp">{{ item.up }}</span>

        <img class="downImg" v-if="item.downIcon" :src="item.downIcon" />
        <span v-if="item.down" class="captionBoxDown">{{ item.down }}</span>
      </div>
      <slot></slot>
    </div>
  </div>
